...
class WeatherAdapter(private var weatherList: List<WeatherItem>) : RecyclerView.Adapter<WeatherViewHolder>() {
    ...
    override fun onBindViewHolder(holder: WeatherViewHolder, position: Int) {
        ...
        holder.temperature.text = "\uD83C\uDF21\uFE0F Temperature: ${kelvinToCelsius(weatherItem.main.temp)}ºC"
        holder.tempFL.text = "Feels like: ${tempKelvin2Icon(weatherItem.main.feelsLike)}"
        holder.tempMax.text = "Max: ${kelvinToCelsius(weatherItem.main.tempMax)}ºC"
        holder.tempMin.text = "Min: ${kelvinToCelsius(weatherItem.main.tempMin)}ºC"
        holder.humidity.text = "Humidity: ${weatherItem.main.humidity}%"
